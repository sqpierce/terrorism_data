  ...
  module Graph
    ...
    class Plot < Graph
      ...
      def get_x_values
        ...
        # SP: added to restrict to integer values
        scale_division = scale_division < 1.0 ? 1 : scale_division.to_i
        #RAILS_DEFAULT_LOGGER.error("#{min_value}, #{max_value}, #{scale_division}")
        rv = []
      ...
      def draw_data
        ...
        for data in @data
          ...
          # SP: taking out the line drawing stuff so this will render faster
          #if area_fill
